...
inline Eigen::Matrix3d compute_change_of_basis_operation(
...
private:
  ...
  // Reflection coordinate frame
  Eigen::Matrix3d R_;

  // Conditional-distribution quantities
  Eigen::Vector3d mu_;
  Eigen::Matrix3d S_;
  DerivativeMatrices dS_;
